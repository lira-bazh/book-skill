...
test('builds RuTracker search URL with encoded query', () => {
  const searchUrl = new URL(buildRutrackerSearchUrl(' Сто лет одиночества  Маркес '));
...
test('extracts RuTracker links only from title cells', () => {
  const html = `
    <table>
      <tr>
        <td>
          <a href="viewtopic.php?t=100">Сто лет одиночества Маркес MP3</a>
        </td>
      </tr>
      <tr>
        <td class="t-title-col">
          <a href="viewtopic.php?t=200">Сто лет одиночества Маркес MP3</a>
        </td>
      </tr>
    </table>
  `;
...
test('requires all search words in RuTracker result text', () => {
  const html = `
    <table>
      <tr>
        <td class="t-title-col">
          <a href="viewtopic.php?t=100">Сто лет одиночества MP3</a>
        </td>
      </tr>
      <tr>
        <td class="t-title-col">
...
test('requires MP3 in RuTracker result text', () => {
  const html = `
    <table>
      <tr>
        <td class="t-title-col">
...
test('deduplicates RuTracker links and respects maxResults', () => {
  const html = `
    <table>
      <tr>
        <td class="t-title-col">
          <a href="/forum/viewtopic.php?t=100">Сто лет одиночества Маркес MP3</a>
        </td>
      </tr>
      <tr>
        <td class="t-title-col">
          <a href="https://rutracker.org/forum/viewtopic.php?t=100">Сто лет одиночества Маркес MP3</a>
        </td>
      </tr>
      <tr>
        <td class="t-title-col">
  ...
  assert.deepEqual(
    extractMatchingRutrackerUrls(html, 'Сто лет одиночества Маркес', 'https://rutracker.org/forum/', {
      maxResults: 1,
    }),
      ...
      return {
        ...
        html: `
          <table>
            <tr>
              <td class="t-title-col">
                <a href="viewtopic.php?t=200">Полковнику никто не пишет Маркес MP3</a>
              </td>
            </tr>
          </table>
        `,
