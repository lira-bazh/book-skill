...
- открывает LiveLib, Yandex Books, Litres и RuTracker;
...
- `rutracker-books.mjs` работает с поиском RuTracker, topic URL, названием,
  длительностью и чтецом аудиокниги.
...
Логин Litres и RuTracker выполняется вручную пользователем в открытом браузере.
